...
const Card = ({img,text,setIsStakeDialogOpen,isStakeDialogOpen,showWithdrawDialog,setShowWithdrawDialog,type}) => {
  return (
	<div  className={` w-[300px] rounded-lg flex flex-col mx-2  my-2  lg:w-[500px]  shadow-xl`} >
			...
			<div className='flex justify-center   rounded-b-md bottom-0 relative cursor-pointer w-full' 
				onClick={ e=>{type===0?setIsStakeDialogOpen({...isStakeDialogOpen, open:true}):setShowWithdrawDialog(true)}}>
